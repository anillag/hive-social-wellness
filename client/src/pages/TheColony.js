    ...
    <div className="w-full h-screen flex bg-[#171718] ">
      <div className=" m-auto w-full h-[680px] sm:max-w-[1000px] shadow-2xl shadow-[#585757] bg-[#f5f5f5] rounded-3xl">
        <div className="py-10 flex justify-center">
          <div className="text-9xl text-[#f0c965]">
            {" "}
            <BsPersonCircle />{" "}
          </div>
        </div>
        <div>
          <p className="text-4xl text-center text-[#f0c965]">
            {" "}
            {`${user.username}`}{" "}
          </p>
        </div>
        ...
        <div className="flex justify-center mt-10">
          <div className=" flex flex-col px-20">
            <h2 className="text-3xl pb-3 text-center text-[#5f5f5f]">
              {" "}
              FRIENDS{" "}
            </h2>
            <p className="text-lg text-[#5f5f5f] text-center">
              {" "}
              <FriendList
            ...
            {userParam && (
              <button
                className="btn ml-auto text-3xl  text-[#e1e0d6]"
                onClick={handleClick}
              >
                Add Friend
              </button>
